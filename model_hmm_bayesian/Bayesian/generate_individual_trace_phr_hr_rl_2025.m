...
for ani=1:size(WT_ind_bestparameters,1)
 
    nblock=200;

    alpha=WT_ind_bestparameters(ani,1);

    [actions,pressn,state]=generate_simulate_rl(alpha,1,nblock);
...
for ani=1:size(grin2a_ind_bestparameters,1)
 
    nblock=200;
    alpha=grin2a_ind_bestparameters(ani,1);
