...
%%
load('number_of_significant_neuron_data.mat')

%% example code of getting this matrix:
...
% for si=1:numel(S)
%     
%         if ~isempty(dir(strcat('raw data path\',S(si).name,'\','UnalignedData.mat')))
%             
%             RasterDatafilepath=strcat('raw data path\',S(si).name,'\','RasterData.mat');
%             UnalignedDatafilepath=strcat('raw data path\',S(si).name,'\','UnalignedData.mat');
%             
% 
...
%%
load('FS_RS_4moresession.mat','RSidx','Num_seq');
