%for resample
%atlas download from
%http://download.alleninstitute.org/informatics-archive/current-release/mouse_ccf/annotation/ccf_2022/structure_masks/structure_masks_10/

VACC=niftiread('\\Fenglab03\Yiyun\20230410_fUS_seedmap\regions\39_ACAd.nii');
VPL=niftiread('\\Fenglab03\Yiyun\20230410_fUS_seedmap\regions\972_PL.nii');
VIL=niftiread('\\Fenglab03\Yiyun\20230410_fUS_seedmap\regions\44_ILA.nii');

VSTRd=niftiread('\\Fenglab03\Yiyun\20230410_fUS_seedmap\regions\485_STRd.nii');
VSTRv=niftiread('\\Fenglab03\Yiyun\20230410_fUS_seedmap\regions\493_STRv.nii');

VHPF=niftiread('\\Fenglab03\Yiyun\20230410_fUS_seedmap\regions\1089_HPF.nii');

VMD=niftiread('\\Fenglab03\Yiyun\20230410_fUS_seedmap\regions\362_MD.nii');
...
vqSTRd=Resample(VSTRd);
vqSTRv=Resample(VSTRv);
...
%%
save('\\Fenglab03\Yiyun\20230410_fUS_seedmap\region_atlas_newly_sample_v5_240823resam_newreg.mat','vqSSp','vqDORsm','vqDORpm','vqHPF','vqMO','vqHY','vqSSs','vqPTLp','vqTH','vqIsoCortex','vqMB');
