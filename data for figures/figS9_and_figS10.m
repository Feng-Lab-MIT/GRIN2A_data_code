%%
% this is for the supplementary figure 9 and 10. 
close all
clear all

load('SSFO_figS9_and_figS10.mat');

%%
figure; title('SSFO')
data=SSFO_OFF;
IDs={'3462_1','3462_2','10694_9','10694_10','5962_5','5982_7','5982_6'}; %Mutant ID, enable this line when running to get Mutant data 
%IDs={'5962_4','5962_7','10692_6','5982_5','5982_3'}; %WT ID, enable this
%line when running to get WT data 
